...
const leftArrow = `<button type="button" class="button button__arrow arrow-to-start-button-js">${leftArrowIcon}</button>`;
const rightArrow = `<button type="button" class="button button__arrow arrow-to-end-button-js">${rightArrowIcon}</button>`;
const dots = '<div class="dots">...</div>'
const currentBtn = currentPage => `<button type="button" class="button button__page--current">${currentPage}</button>`;
const pageBtn = page => `<button type="button" class="button button__page">${page}</button>`;
